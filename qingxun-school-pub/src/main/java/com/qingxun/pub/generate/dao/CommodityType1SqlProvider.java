...
import com.qingxun.pub.generate.pojo.CommodityType1Example.Criteria;
import com.qingxun.pub.generate.pojo.CommodityType1Example.Criterion;
...
public class CommodityType1SqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(CommodityType1Example example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("commodity_type1");
     ...
     * @mbg.generated
     */
    public String deleteByExample(CommodityType1Example example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("commodity_type1");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String selectByExample(CommodityType1Example example) {
        SQL sql = new SQL();
        ...
        sql.SELECT("type1_id");
        sql.SELECT("mer_id");
        sql.SELECT("type1_name");
        sql.FROM("commodity_type1");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        CommodityType1 record = (CommodityType1) parameter.get("record");
        CommodityType1Example example = (CommodityType1Example) parameter.get("example");
        ...
        if (record.getType1Name() != null) {
            sql.SET("type1_name = #{record.type1Name,jdbcType=VARCHAR}");
        }
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, CommodityType1Example example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
